...
I have fixed the release workflow and published a fresh package as:

https://github.com/Gr33k3D/FullSpectrum-Studio/releases/tag/v0.4.6-community-preview

For Windows, use either:

- FullSpectrum-Studio-Windows-Setup-v0.4.6.exe
- FullSpectrum-Studio-Windows-Portable-v0.4.6.zip
