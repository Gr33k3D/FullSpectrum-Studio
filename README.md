...
Latest correctness update: v0.4.3 Community Preview fixes mixed-color prediction
to follow Bambu Studio's loaded-color reconstruction.
...
are ad-hoc signed rather than notarized.
